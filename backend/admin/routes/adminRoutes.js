...
const { authenticateUser, requireAdmin } = require('../../shared/middleware/auth');
const { requireBodyFields } = require('../../shared/middleware/validator');

const adminRegistrationRoutes = require('./adminRegistrationRoutes');

const router = express.Router();

// Public Administrator Registration Workflow (Unauthenticated)
router.use('/registration', adminRegistrationRoutes);
...
const refundController = require('../../shared/controllers/refundController');
