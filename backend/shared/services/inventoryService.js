...
const isApolloHospital = (id) => id === 'hosp-1' || id === '11111111-1111-1111-1111-111111111111';
const isFortisHospital = (id) => id === 'hosp-2' || id === '22222222-2222-2222-2222-222222222222';
...
const devInventory = [
  ...
  // --- ADDITIONAL REALISTIC DEMO LOTS (Apollo Hub: hosp-1) ---
  {
    ...
    unitPrice: 95.00,
    mrp: 100.00,
    concessionRate: 95.00,
    concessionPercent: 5.0,
    costRate: 90.00,
    acquisitionCost: 90.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Apollo_ABC123_Invoice.pdf',
    billStoragePath: '11111111-1111-1111-1111-111111111111/b0000007/Apollo_ABC123_Invoice.pdf',
  ...
  },
  {
    ...
    hospitalCity: 'Mumbai',
    hospitalState: 'Maharashtra',
    medicineId: 'a0000010-0000-0000-0000-000000000010',
    medicine_id: 'a0000010-0000-0000-0000-000000000010',
    medicineName: 'Ceftriaxone Injection (Monocef)',
    ...
    minStockLevel: 50,
    reorderLevel: 50,
    shelfLocation: 'Cold Storage Vault C-1',
    manufacturingDate: '2024-03-15',
    mfgDate: '2024-03-15',
    expiryDate: new Date(Date.now() + 220 * 86400000).toISOString().split('T')[0],
    unitPrice: 58.00,
    mrp: 75.00,
    concessionRate: 58.00,
    concessionPercent: 22.67,
    costRate: 50.00,
    acquisitionCost: 50.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Apollo_MC88_Invoice.pdf',
    billStoragePath: '11111111-1111-1111-1111-111111111111/b0000008/Apollo_MC88_Invoice.pdf',
  ...
  },
  {
    ...
    hospitalCity: 'Mumbai',
    hospitalState: 'Maharashtra',
    medicineId: 'a0000011-0000-0000-0000-000000000011',
    medicine_id: 'a0000011-0000-0000-0000-000000000011',
    medicineName: 'Insulin Glargine (Lantus)',
    brandName: 'Insulin Glargine (Lantus)',
    genericName: 'Insulin Glargine IP',
    ...
    packing: '5 Cartridges / Box',
    packSize: '5 Cartridges / Box',
    unit: 'Cartridge',
    unitsPerPack: 5,
    numberOfPacks: 8,
    manufacturer: 'Sanofi India Ltd.',
    batchNumber: 'LT-EXP-908',
    batchNo: 'LT-EXP-908',
    quantity: 40,
    totalQuantity: 40,
    reservedQuantity: 0,
    ...
    minStockLevel: 15,
    reorderLevel: 15,
    shelfLocation: 'Refrigerated Bay R-2',
    manufacturingDate: '2024-01-10',
    mfgDate: '2024-01-10',
    expiryDate: new Date(Date.now() + 190 * 86400000).toISOString().split('T')[0],
    unitPrice: 620.00,
    mrp: 850.00,
    concessionRate: 620.00,
    concessionPercent: 27.06,
    costRate: 560.00,
    acquisitionCost: 560.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Apollo_LT908_Invoice.pdf',
    billStoragePath: '11111111-1111-1111-1111-111111111111/b0000009/Apollo_LT908_Invoice.pdf',
    createdAt: '2024-01-15T00:00:00.000Z',
    updatedAt: '2024-01-15T00:00:00.000Z',
  },
  {
    ...
    hospitalCity: 'Mumbai',
    hospitalState: 'Maharashtra',
    medicineId: 'a0000012-0000-0000-0000-000000000012',
    medicine_id: 'a0000012-0000-0000-0000-000000000012',
    medicineName: 'Colistimethate Sodium 1 MIU (Xylistin)',
    brandName: 'Colistimethate Sodium 1 MIU (Xylistin)',
    genericName: 'Colistimethate Sodium IP',
    composition: 'Colistimethate Sodium 1,000,000 IU',
    category: 'Critical Care & Antibiotics',
    dosageForm: 'Injection',
    form: 'Injection',
    dosage: '1 MIU Vial',
    ...
    minStockLevel: 30,
    reorderLevel: 30,
    shelfLocation: 'Cold Storage Vault C-3',
    manufacturingDate: '2024-02-01',
    mfgDate: '2024-02-01',
    expiryDate: new Date(Date.now() + 150 * 86400000).toISOString().split('T')[0],
    unitPrice: 950.00,
    mrp: 1450.00,
    concessionRate: 950.00,
    concessionPercent: 34.48,
    costRate: 850.00,
    acquisitionCost: 850.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Apollo_COL1M_Invoice.pdf',
    billStoragePath: '11111111-1111-1111-1111-111111111111/b0000010/Apollo_COL1M_Invoice.pdf',
  ...
  },
  {
    ...
    hospitalCity: 'Mumbai',
    hospitalState: 'Maharashtra',
    medicineId: 'a0000013-0000-0000-0000-000000000013',
    medicine_id: 'a0000013-0000-0000-0000-000000000013',
    medicineName: 'Midazolam Injection 5mg/ml (Mezolam)',
    brandName: 'Midazolam Injection 5mg/ml (Mezolam)',
    genericName: 'Midazolam Hydrochloride',
    composition: 'Midazolam 5mg/ml',
    category: 'Anaesthesia & ICU Sedation',
    dosageForm: 'Injection',
    form: 'Injection',
    dosage: '5mg/ml 10ml Ampoule',
    strength: '5mg/ml 10ml Ampoule',
    packing: '5 Ampoules / Box',
    packSize: '5 Ampoules / Box',
    unit: 'Ampoule',
    unitsPerPack: 5,
    numberOfPacks: 52,
    ...
    minStockLevel: 40,
    reorderLevel: 40,
    shelfLocation: 'Narcotics Vault (Restricted)',
    manufacturingDate: '2024-01-20',
    mfgDate: '2024-01-20',
    expiryDate: new Date(Date.now() + 140 * 86400000).toISOString().split('T')[0],
    unitPrice: 85.00,
    mrp: 120.00,
    concessionRate: 85.00,
    concessionPercent: 29.17,
    costRate: 70.00,
    acquisitionCost: 70.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Apollo_MDZ05_Invoice.pdf',
    billStoragePath: '11111111-1111-1111-1111-111111111111/b0000011/Apollo_MDZ05_Invoice.pdf',
  ...
  },
  {
    ...
    hospitalCity: 'Mumbai',
    hospitalState: 'Maharashtra',
    medicineId: 'a0000014-0000-0000-0000-000000000014',
    medicine_id: 'a0000014-0000-0000-0000-000000000014',
    medicineName: 'Tranexamic Acid 500mg (Pause)',
    brandName: 'Tranexamic Acid 500mg (Pause)',
    genericName: 'Tranexamic Acid IP',
    composition: 'Tranexamic Acid 500mg',
    category: 'Haemostatics & Trauma Care',
    dosageForm: 'Tablet',
    form: 'Tablet',
    dosage: '500mg Tablets',
    strength: '500mg',
    ...
    mfgDate: '2024-02-15',
    expiryDate: new Date(Date.now() + 170 * 86400000).toISOString().split('T')[0],
    unitPrice: 140.00,
    mrp: 180.00,
    concessionRate: 140.00,
    concessionPercent: 22.22,
    costRate: 120.00,
    acquisitionCost: 120.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Apollo_TXA500_Invoice.pdf',
    billStoragePath: '11111111-1111-1111-1111-111111111111/b0000012/Apollo_TXA500_Invoice.pdf',
    createdAt: '2024-02-20T00:00:00.000Z',
    updatedAt: '2024-02-20T00:00:00.000Z',
  },
  // --- ADDITIONAL REALISTIC DEMO LOTS (Fortis Peer: hosp-2) ---
  {
    ...
    hospitalCity: 'Gurugram',
    hospitalState: 'Haryana',
    medicineId: 'a0000015-0000-0000-0000-000000000015',
    medicine_id: 'a0000015-0000-0000-0000-000000000015',
    medicineName: 'Remdesivir IV (Covifor)',
    brandName: 'Remdesivir IV (Covifor)',
    genericName: 'Remdesivir 100mg Lyophilized',
    composition: 'Remdesivir 100mg',
    category: 'Antivirals & Pandemic Reserves',
    dosageForm: 'Injection',
    form: 'Injection',
    dosage: '100mg Vial',
    strength: '100mg Vial',
    ...
    minStockLevel: 10,
    reorderLevel: 10,
    shelfLocation: 'Cold Storage Vault F-1',
    manufacturingDate: '2024-01-10',
    mfgDate: '2024-01-10',
    expiryDate: new Date(Date.now() + 160 * 86400000).toISOString().split('T')[0],
    unitPrice: 2400.00,
    mrp: 3400.00,
    concessionRate: 2400.00,
    concessionPercent: 29.41,
    costRate: 2100.00,
    acquisitionCost: 2100.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Fortis_RDV401_Invoice.pdf',
    billStoragePath: '22222222-2222-2222-2222-222222222222/b0000013/Fortis_RDV401_Invoice.pdf',
    createdAt: '2024-01-15T00:00:00.000Z',
    updatedAt: '2024-01-15T00:00:00.000Z',
  },
  {
    ...
    hospitalCity: 'Gurugram',
    hospitalState: 'Haryana',
    medicineId: 'a0000016-0000-0000-0000-000000000016',
    medicine_id: 'a0000016-0000-0000-0000-000000000016',
    medicineName: 'Human Albumin 20%',
    brandName: 'Human Albumin 20%',
    genericName: 'Human Albumin Infusion IP 20%',
    composition: 'Normal Serum Albumin (Human) 20%',
    category: 'Critical Care & Plasma Volume Expanders',
    dosageForm: 'Infusion',
    form: 'Infusion',
    dosage: '20% 100ml Infusion Bottle',
    strength: '20% 100ml Infusion Bottle',
    packing: '1 Infusion Bottle / Box',
    packSize: '1 Infusion Bottle / Box',
    unit: 'Bottle',
    unitsPerPack: 1,
    numberOfPacks: 28,
    manufacturer: 'Reliance Life Sciences Ltd.',
    batchNumber: 'ALB9941',
    batchNo: 'ALB9941',
    quantity: 28,
    totalQuantity: 28,
    ...
    minStockLevel: 8,
    reorderLevel: 8,
    shelfLocation: 'Cold Storage Vault F-2',
    manufacturingDate: '2024-02-10',
    mfgDate: '2024-02-10',
    expiryDate: new Date(Date.now() + 200 * 86400000).toISOString().split('T')[0],
    unitPrice: 4200.00,
    mrp: 5600.00,
    concessionRate: 4200.00,
    concessionPercent: 25.0,
    costRate: 3800.00,
    acquisitionCost: 3800.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Fortis_ALB9941_Invoice.pdf',
    billStoragePath: '22222222-2222-2222-2222-222222222222/b0000014/Fortis_ALB9941_Invoice.pdf',
    createdAt: '2024-02-15T00:00:00.000Z',
    updatedAt: '2024-02-15T00:00:00.000Z',
  },
  {
    ...
    hospitalCity: 'Gurugram',
    hospitalState: 'Haryana',
    medicineId: 'a0000017-0000-0000-0000-000000000017',
    medicine_id: 'a0000017-0000-0000-0000-000000000017',
    medicineName: 'Dexamethasone Sodium Phosphate',
    brandName: 'Dexamethasone Sodium Phosphate',
    genericName: 'Dexamethasone 4mg/ml',
    composition: 'Dexamethasone Sodium Phosphate 4mg/ml',
    category: 'Corticosteroids & Critical Care',
    dosageForm: 'Injection',
    form: 'Injection',
    dosage: '4mg/ml 2ml Vial',
    strength: '4mg/ml 2ml Vial',
    ...
    manufacturingDate: '2024-03-01',
    mfgDate: '2024-03-01',
    expiryDate: new Date(Date.now() + 250 * 86400000).toISOString().split('T')[0],
    unitPrice: 12.00,
    mrp: 18.00,
    concessionRate: 12.00,
    concessionPercent: 33.33,
    costRate: 9.00,
    acquisitionCost: 9.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Fortis_DEX092_Invoice.pdf',
    billStoragePath: '22222222-2222-2222-2222-222222222222/b0000015/Fortis_DEX092_Invoice.pdf',
    createdAt: '2024-03-05T00:00:00.000Z',
    updatedAt: '2024-03-05T00:00:00.000Z',
  },
  {
    ...
    hospitalCity: 'Gurugram',
    hospitalState: 'Haryana',
    medicineId: 'a0000018-0000-0000-0000-000000000018',
    medicine_id: 'a0000018-0000-0000-0000-000000000018',
    medicineName: 'PantoCare 40',
    brandName: 'PantoCare 40',
    genericName: 'Pantoprazole Gastro-Resistant',
    composition: 'Pantoprazole 40mg',
    category: 'Gastrointestinal & Acid Reduction',
    dosageForm: 'Tablet',
    form: 'Tablet',
    dosage: '40mg Tablets',
    ...
    manufacturingDate: '2024-02-15',
    mfgDate: '2024-02-15',
    expiryDate: new Date(Date.now() + 280 * 86400000).toISOString().split('T')[0],
    unitPrice: 75.00,
    mrp: 95.00,
    concessionRate: 75.00,
    concessionPercent: 21.05,
    costRate: 60.00,
    acquisitionCost: 60.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Fortis_PTC40A_Invoice.pdf',
    billStoragePath: '22222222-2222-2222-2222-222222222222/b0000016/Fortis_PTC40A_Invoice.pdf',
    createdAt: '2024-02-20T00:00:00.000Z',
    updatedAt: '2024-02-20T00:00:00.000Z',
  },
  {
    ...
    hospitalCity: 'Gurugram',
    hospitalState: 'Haryana',
    medicineId: 'a0000019-0000-0000-0000-000000000019',
    medicine_id: 'a0000019-0000-0000-0000-000000000019',
    ...
    mfgDate: '2024-01-25',
    expiryDate: new Date(Date.now() + 290 * 86400000).toISOString().split('T')[0],
    unitPrice: 55.00,
    mrp: 72.00,
    concessionRate: 55.00,
    concessionPercent: 23.61,
    costRate: 45.00,
    acquisitionCost: 45.00,
    status: 'AVAILABLE',
    purchaseBillUrl: '/uploads/bills/Fortis_AMX500_Invoice.pdf',
    billStoragePath: '22222222-2222-2222-2222-222222222222/b0000017/Fortis_AMX500_Invoice.pdf',
...
const inventoryService = {
  ...
  async getInventory({ reqUser = null, hospitalId = null, status = 'all', category = 'all', search = '', page = 1, limit = 50 } = {}) {
    ...
    if (effectiveHospitalId) {
      results = results.filter((i) => {
        const itemHospId = i.hospitalId || i.hospital_id;
        if (isApolloHospital(effectiveHospitalId)) {
          return isApolloHospital(itemHospId);
        }
        if (isFortisHospital(effectiveHospitalId)) {
          return isFortisHospital(itemHospId);
        }
        return itemHospId === effectiveHospitalId;
      });
    }
  ...
  async getLotDetails(lotId, reqUser = null) {
    ...
    if (reqUser?.role === 'hospital') {
      ...
      const lotHospId = lot.hospitalId || lot.hospital_id;
      const isOwner = (lotHospId === userHospId) ||
        (isApolloHospital(userHospId) && isApolloHospital(lotHospId)) ||
        (isFortisHospital(userHospId) && isFortisHospital(lotHospId));
      if (!isOwner) {
  ...
  async getMarketplaceInventory({ currentHospitalId = null, category = 'all', dosageForm = 'all', search = '', page = 1, limit = 50 } = {}) {
    ...
    let filtered = devInventory.filter((lot) => {
      ...
      const isApproved = approvedHospIds.has(hospId) || isApolloHospital(hospId) || isFortisHospital(hospId);
      if (!isApproved) return false;

      // Exclude caller hospital
      if (currentHospitalId) {
        if (hospId === currentHospitalId) return false;
        if (isApolloHospital(currentHospitalId) && isApolloHospital(hospId)) return false;
        if (isFortisHospital(currentHospitalId) && isFortisHospital(hospId)) return false;
      }
      // Exclude expired
