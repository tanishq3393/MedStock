                ...
                {filteredLogs.map((entry) => (
                  <tr key={entry.id} className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="py-3 px-4 whitespace-nowrap">
                      <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase font-mono bg-slate-100 text-slate-700 border border-slate-200">
                        {entry.action}
                      </span>
                    </td>
                    ...
                    {/* Module */}
                    <td className="py-3 px-4 whitespace-nowrap">
                      <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-bold bg-slate-100 text-slate-700 border border-slate-200">
                    ...
                    {/* Description */}
                    <td className="py-3 px-4 text-slate-700 max-w-sm sm:max-w-md">
